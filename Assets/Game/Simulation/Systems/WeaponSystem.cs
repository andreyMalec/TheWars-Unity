...
public sealed class WeaponSystem : ISystem
{
    public void Run(Simulation simulation)
    {
        ...
        foreach (var pair in world.Units)
        {
            ...
            SpawnProjectile(simulation, unit.Team, unit.Id, unit.TargetEntityId, unit.Position, config.Damage, config.ProjectileSpeed);
        ...
        foreach (var pair in world.Turrets)
        {
            ...
            SpawnProjectile(simulation, turret.Team, turret.Id, turret.TargetEntityId, turret.Position, config.Damage, config.ProjectileSpeed);
